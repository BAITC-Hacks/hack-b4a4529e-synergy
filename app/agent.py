...
При purchase_rules_confirmed=false объясните purchase_rule_note как неподтверждённые условия поставщика. Товар с известной ценой и положительным остатком можно добавить в предварительную корзину. Не обещайте отрез произвольной длины как условие продажи поставщика.
